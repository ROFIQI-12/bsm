                            ...
                            <div class="row gx-5 mb-3">
                                <div class="col">
                                    <div class="form-group">
                                        ...
                                        <input id="rangka" type="number" name="rangka" value="{{ old('rangka') }}"
                                            class="form-control" max="9999" placeholder="No Rangka" required
                                            autofocus>
                                        <span class="error-message text-danger" id="error-rangka"></span>
                                    </div>
                                </div>
                            </div>
                            <div class="mb-3">
